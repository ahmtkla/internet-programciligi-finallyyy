                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="index.htm">
                                        <img src="assets/images/king.png" class="h-logo img-fluid blur-up lazyload"
                                            alt="logo">
                                    </a>
                                </div>
                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{ route('app.index') }}" class="nav-link menu-title">Anasayfa</a></li>
                                            <li><a href="{{ route('shop.index') }}" class="nav-link menu-title">Mağaza</a></li>
                                            <li><a href="cart/list.html" class="nav-link menu-title">Cart</a></li>
                                            <li><a href="about-us.html" class="nav-link menu-title">Hakkında</a></li>
                                            <li><a href="contact-us.html" class="nav-link menu-title">İletişim</a>
                                            </li>
                        ...
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="index.htm" class="footer-logo float-start">
                                    <img src="{{ asset('assets/images/king.png') }}" class="f-logo img-fluid blur-up lazyload"
                                        alt="logo">
                                </a>
                            </div>
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +90</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Sivrihisar, Eskişehir
                                            Türkiye</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> esogu221120221012@gmail.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="index.htm" class="font-dark">Anasayfa</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Mağaza</a>
                                    </li>
                                    <li>
                                        <a href="about-us.html" class="font-dark">Hakkında</a>
                                    </li>
                                    <li>
                                        <a href="#" class="font-dark">Blog</a>
                                    </li>
                                    <li>
                                        <a href="contact-us.html" class="font-dark">İletişim</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2023, King Giyim</p>
                    </div>
                </div>
            </div>
        </div>
